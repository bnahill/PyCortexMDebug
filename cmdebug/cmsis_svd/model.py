...
class SVDField(SVDElement):
    def __init__(self, name, derived_from, description, bit_offset, bit_width, access, enumerated_values, modified_write_values, read_action):
        # type: (str, Optional[SVDField], str, int, int, str, Optional[List[SVDEnumeratedValue]], str, str) -> None
        SVDElement.__init__(self)
        self.parent = None # type: Union[SVDRegister, SVDRegisterArray]
        self.name = name
...
class SVDRegisterArray(SVDElement):
    ...
    def __init__(self, name, derived_from, description, address_offset, size,
        ...
        # type: (str, Optional[SVDRegisterArray], str, int, int, str, str, int, int, List[SVDField], str, str, str, str, int, Iterable[int], int) -> None
        SVDElement.__init__(self)
        self.parent = None # type: Optional[SVDPeripheral]
...
class SVDRegister(SVDElement):
    def __init__(self, name, derived_from, description, address_offset, size, access, protection, reset_value, reset_mask,
        ...
        # type: (str, Optional[SVDRegister], str, int, int, str, str, int, int, List[SVDField], str, str, str, str) -> None
        SVDElement.__init__(self)
        self.parent = None # type: Optional[SVDPeripheral]
...
class SVDPeripheral(SVDElement):
    def __init__(self, name, version, derived_from, description, prepend_to_name, base_address, address_block,
        ...
        # type: (str, str, Optional[SVDPeripheral], str, str, int, Optional[SVDAddressBlock], Optional[List[SVDInterrupt]], Optional[List[SVDRegister]], Optional[List[SVDRegisterArray]], int, str, str, int, int, str, str, str) -> None
        SVDElement.__init__(self)
...
class SVDCpu(SVDElement):
    def __init__(self, name, revision, endian, mpu_present, fpu_present, fpu_dp, icache_present,
        ...
        # type: (str, str, str, int, int, int, int, int, int, int, int, int, int, int, int, str) -> None
        SVDElement.__init__(self)
...
class SVDDevice(SVDElement):
    def __init__(self, vendor, vendor_id, name, version, description, cpu, address_unit_bits, width,
        ...
        # type: (str, str, str, str, str, SVDCpu, int, int, List[SVDPeripheral], int, str, str, int, int) -> None
        SVDElement.__init__(self)
